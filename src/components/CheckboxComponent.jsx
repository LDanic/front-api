...
const DropdownCheckboxForm = ({ onCheckboxChange, value, rowIndex, nodeIndex }) => {
    ...
    useEffect(() => {
        ...
        let checkboxes = document.querySelectorAll('.checkinput' + rowIndex + nodeIndex);
    ...
    <form>
        <div className="dropdown">
            ...
            <div className="dropdown-content">
                <label>
                    <input
                        className={"checkinput" + rowIndex.toString() + nodeIndex.toString() }
                        type="checkbox"
                        name="opciones[]"
                        value="PK"
